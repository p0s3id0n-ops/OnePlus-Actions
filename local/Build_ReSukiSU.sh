...
repo init -u https://github.com/p0s3id0n-ops/kernel_manifest.git -b refs/heads/oneplus/${CPU} -m ${FEIL}.xml --depth=1
...
echo "CONFIG_KSU_FULL_NAME_FORMAT=\"%TAG_NAME%-%COMMIT_SHA%-p0s3id0n@PSD\"" >> "$DEFCONFIG_PATH"
...
git clone https://github.com/p0s3id0n-ops/AnyKernel3 --depth=1
